...
/// struct for typed errors of method [`build_screening_key_from_address_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum BuildScreeningKeyFromAddressGetError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`build_screening_key_from_address_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum BuildScreeningKeyFromAddressPostError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`create_sanctions_screening_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateSanctionsScreeningGetError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`create_sanctions_screening_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateSanctionsScreeningPostError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`get_sanctions_screening_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSanctionsScreeningGetError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_sanctions_screening_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSanctionsScreeningPostError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`sanctions_screening_event_subscribe`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SanctionsScreeningEventSubscribeError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`sanctions_screening_event_subscribe_all`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SanctionsScreeningEventSubscribeAllError {
    DefaultResponse(models::Error),
    UnknownValue(serde_json::Value),
}
...
pub async fn build_screening_key_from_address_get(
...
) -> Result<models::BuildScreeningKeyFromAddressOutputs, Error<BuildScreeningKeyFromAddressGetError>>
{
    ...
    let local_var_uri_str = format!(
        "{}/{address}/buildScreeningKeyFromAddress",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BuildScreeningKeyFromAddressGetError> =
...
pub async fn build_screening_key_from_address_post(
    configuration: &configuration::Configuration,
    address: &str,
    body: models::BuildScreeningKeyFromAddressInputs,
    kld_id: Option<&str>,
    kld_from: Option<&str>,
    kld_ethvalue: Option<i32>,
    kld_gas: Option<i32>,
...
) -> Result<models::BuildScreeningKeyFromAddressOutputs, Error<BuildScreeningKeyFromAddressPostError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BuildScreeningKeyFromAddressPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_sanctions_screening_get(
    configuration: &configuration::Configuration,
    address: &str,
    uuid: &str,
    payer_phone: &str,
    ...
    kld_gasprice: Option<i32>,
    kld_transaction: Option<&str>,
) -> Result<serde_json::Value, Error<CreateSanctionsScreeningGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/{address}/createSanctionsScreening",
        local_var_configuration.base_path,
        address = crate::apis::urlencode(address)
    );
    let mut local_var_req_builder =
    ...
    local_var_req_builder = local_var_req_builder.query(&[("uuid", &uuid.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("payerPhone", &payer_phone.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("payeePHone", &payee_p_hone.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSanctionsScreeningGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_sanctions_screening_post(
    configuration: &configuration::Configuration,
    address: &str,
    body: models::CreateSanctionsScreeningInputs,
    kld_id: Option<&str>,
    kld_from: Option<&str>,
    kld_ethvalue: Option<i32>,
    kld_gas: Option<i32>,
    ...
    kld_blocknumber: Option<&str>,
    kld_acktype: Option<&str>,
) -> Result<serde_json::Value, Error<CreateSanctionsScreeningPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSanctionsScreeningPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sanctions_screening_get(
    configuration: &configuration::Configuration,
    address: &str,
    key: &str,
    kld_id: Option<&str>,
    ...
    kld_gasprice: Option<i32>,
    kld_transaction: Option<&str>,
) -> Result<models::GetSanctionsScreeningOutputs, Error<GetSanctionsScreeningGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/{address}/getSanctionsScreening",
        local_var_configuration.base_path,
        address = crate::apis::urlencode(address)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSanctionsScreeningGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sanctions_screening_post(
    configuration: &configuration::Configuration,
    address: &str,
    body: models::GetSanctionsScreeningInputs,
    kld_id: Option<&str>,
    kld_from: Option<&str>,
    kld_ethvalue: Option<i32>,
    kld_gas: Option<i32>,
    ...
    kld_blocknumber: Option<&str>,
    kld_acktype: Option<&str>,
) -> Result<models::GetSanctionsScreeningOutputs, Error<GetSanctionsScreeningPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSanctionsScreeningPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sanctions_screening_event_subscribe(
    configuration: &configuration::Configuration,
    body: models::IntermediaryRegistrationSubscribeRequest,
) -> Result<models::SanctionsScreeningEventEvent, Error<SanctionsScreeningEventSubscribeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/SanctionsScreeningEvent/subscribe",
        local_var_configuration.base_path
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SanctionsScreeningEventSubscribeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn sanctions_screening_event_subscribe_all(
    configuration: &configuration::Configuration,
    address: &str,
    body: models::IntermediaryRegistrationSubscribeRequest,
) -> Result<models::SanctionsScreeningEventEvent, Error<SanctionsScreeningEventSubscribeAllError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/{address}/SanctionsScreeningEvent/subscribe",
        local_var_configuration.base_path,
        address = crate::apis::urlencode(address)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SanctionsScreeningEventSubscribeAllError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
